...
def loadConfig():
    ...
    configFile.close()
    return configJson['emailaddress'], configJson['password'], configJson['pop3_server'], configJson['smtp_server'], configJson['teamNumber'], configJson['orgName'], configJson['toAddress']
